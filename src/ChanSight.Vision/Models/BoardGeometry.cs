    ...
    public static BoardGeometry CreateCanonical()
    {
        ...
        for (var row = 0; row < 4; row++)
        {
            for (var col = 0; col < 7; col++)
            {
                ...
                {
                    (0, 0) => (547.5, 444.75), (0, 1) => (664.5, 444.75), (0, 2) => (781.5, 448.5),
                    (0, 3) => (893.25, 446.25), (0, 4) => (1011.0, 445.5), (0, 5) => (1126.5, 442.5),
                    (0, 6) => (1241.25, 442.5),
                    (1, 0) => (592.5, 519.75), (1, 1) => (712.5, 518.25), (1, 2) => (832.5, 519.0),
                    (1, 3) => (951.75, 519.0), (1, 4) => (1069.5, 516.75), (1, 5) => (1192.5, 517.5),
                    (1, 6) => (1308.75, 513.75),
                    (2, 0) => (519.75, 592.5), (2, 1) => (643.5, 594.0), (2, 2) => (767.25, 591.75),
                    (2, 3) => (891.0, 591.0), (2, 4) => (1013.25, 591.75), (2, 5) => (1140.75, 591.75),
                    (2, 6) => (1260.0, 591.75),
                    (3, 0) => (567.75, 672.0), (3, 1) => (697.5, 675.75), (3, 2) => (825.75, 675.75),
                    (3, 3) => (954.0, 675.75), (3, 4) => (1083.0, 672.75), (3, 5) => (1206.0, 674.25),
                    (3, 6) => (1334.25, 675.0),
        ...
        {
            (410.25, 782.25), (527.25, 781.5), (647.25, 781.5), (762.0, 783.0), (878.25, 783.0),
            (996.0, 782.25), (1113.75, 783.75), (1230.75, 782.25), (1351.5, 783.0)
        };
